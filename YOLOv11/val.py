...
# Path to the trained YOLOv11 model weights
...
def main():
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        print("   Please train the YOLOv11 model first using train.py")
        sys.exit(1)
    ...
    print(f"🚀 Starting Validation for YOLOv11 on dataset: {DATA_YAML_PATH}")
    ...
    # ── Results summary ──────────────────────────────────────────────
    print("\n" + "━" * 50)
    print("📈 YOLOv11 VALIDATION METRICS OVERVIEW")
    print("━" * 50)
